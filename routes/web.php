...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/privacy', function () {
        return '<h1>Політика конфіденційності</h1><p>Ми використовуємо дані клієнтів виключно для обробки замовлень та комунікації. Дані не передаються третім особам.</p>';
    });
