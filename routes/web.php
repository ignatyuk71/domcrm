...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/privacy', function () {
        return '<h1>Політика конфіденційності</h1>
                <p>Цей додаток (CRM) використовується виключно для внутрішніх потреб компанії.</p>
                <p>Ми збираємо імена та повідомлення клієнтів лише для обробки замовлень.</p>
                <p>Дані не передаються третім особам.</p>';
    });
