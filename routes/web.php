...
use App\Http\Controllers\PieceworkDayController;
...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('role:owner')->group(function () {
        ...
        Route::get('/api/work-time/piecework-days', [PieceworkDayController::class, 'index']);
        Route::put('/api/work-time/employees/{employee}/piecework-day', [PieceworkDayController::class, 'save'])->whereNumber('employee');
    ...
    Route::middleware('role:owner')->group(function () {
        ...
        Route::get('/api/production-costs/cardboard-batches', [ProductionCostController::class, 'cardboardData']);
        Route::post('/api/production-costs/cardboard-batches', [ProductionCostController::class, 'saveCardboard']);
        Route::put('/api/production-costs/cardboard-batches/{batch}', [ProductionCostController::class, 'saveCardboard'])->whereNumber('batch');
        ...
        Route::get('/api/production-costs/laminate-calculations', [ProductionCostController::class, 'laminateData']);
        Route::post('/api/production-costs/laminate-calculations', [ProductionCostController::class, 'saveLaminate']);
        Route::put('/api/production-costs/laminate-calculations/{batch}', [ProductionCostController::class, 'saveLaminate'])->whereNumber('batch');
        Route::get('/api/production-costs/tape-batches', [ProductionCostController::class, 'tapeData']);
        Route::post('/api/production-costs/tape-batches', [ProductionCostController::class, 'saveTape']);
        Route::put('/api/production-costs/tape-batches/{batch}', [ProductionCostController::class, 'saveTape'])->whereNumber('batch');
