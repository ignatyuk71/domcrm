<template>
  <section class="workspace">
    <OrdersTopbar
      ...
      :hold-filter-active="holdFilterActive"
...
const holdFilterOptions = [2, 3, 4, 5, 6];
const holdFilterDays = ref(2);
...
function toggleHoldFilter() {
  holdFilterActive.value = !holdFilterActive.value;
  filters.delivery_hold_days = holdFilterActive.value ? holdFilterDays.value : null;
  filters.page = 1;
  fetchData();
}
