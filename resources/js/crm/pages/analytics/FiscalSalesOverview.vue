  ...
  <section class="fiscal-overview" aria-label="Фіскальні продажі">
    ...
    <div class="fiscal-note">
      ...
      <div>
        ...
        <p>Джерело: успішні нетестові чеки з фіскальним номером, збережені в CRM. Чеки, створені поза CRM, можуть бути відсутні. Фільтри статусу, оплати й заліку замовлень впливають лише на нижній операційний блок.</p>
      </div>
    </div>
