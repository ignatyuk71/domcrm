...
export function fetchStreets({ cityRef, settlementRef, query, limit = 25 }) {
    return http.get('/nova-poshta/streets', { params: { city_ref: cityRef, settlement_ref: settlementRef, q: query, limit } });
}
