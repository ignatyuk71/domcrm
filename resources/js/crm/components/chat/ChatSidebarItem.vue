<template>
  <button
    ...
    :class="{ active: isActive, 'has-unread': item.unread_count > 0 }"
  ...
  >
    <div class="chat-item-header">
      <div class="chat-item-title">
        ...
        <span class="chat-item-name">{{ item.customer_name || 'Клієнт Meta' }}</span>
      </div>
      <span class="chat-item-time">{{ item.last_message_time || '' }}</span>
    </div>

    <div class="chat-item-body">
      <div class="chat-item-preview" :class="{ 'is-unread': item.unread_count > 0 }">
