...
JSON;
        ...
        $basePrompt = trim($promptVersion->system_prompt) . "\n\n"
            ...
            . "- checkout_request: попросити дані для оформлення замовлення.\n"
            ...
            . "7. Одне уточнююче питання за раз.\n\n"
            . "Обмеження:\n"
            ...
            . "5. Заповнюй missing_slots тільки коли клієнт реально переходить до оформлення або вже хоче купити. На етапах interest та selection для звичайної консультації missing_slots має бути порожнім масивом.\n"
