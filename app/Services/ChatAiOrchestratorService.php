...
JSON;
        ...
        $basePrompt = trim($promptVersion->system_prompt) . "\n\n"
            ...
            . "8. Перед checkout_request, якщо позиції вже зібрані, але клієнт ще не підтвердив завершення підбору, коротко підсумуй вибране і спитай на кшталт: 'Щось ще додаємо чи оформляємо замовлення?'.\n"
