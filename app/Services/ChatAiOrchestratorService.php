...
class ChatAiOrchestratorService
{
    ...
    private function buildSystemPrompt(ChatAiPromptVersion $promptVersion): string
    {
        ...
        $basePrompt = trim($promptVersion->system_prompt) . "\n\n"
            ...
            . "15. Якщо після попереднього уточнення клієнт дає новий явний запит на іншу модель, інший колір або інше фото, наприклад 'і ще покажіть домашні чорні на 39', трактуй це як новий show-request. Не додавай до замовлення попередній товар автоматично і не повертайся до старого незавершеного підтвердження.\n"
            ...
            . "12. Якщо в попередньому ході вже був send_collage або send_product_photo, не повторюй той самий медіа-формат без нової користі. Наступна відповідь має рухати діалог вперед: порада, точніше фото, додавання до замовлення або оформлення.\n"
            ...
            . "14. У reply не використовуй формулювання 'кошик', 'додати в кошик', 'у кошик'. Для клієнта завжди використовуй формулювання через 'замовлення': 'Бажаєте замовити?', 'додати до замовлення', 'Бажаєте ще щось додати до замовлення?'.\n\n"
            ...
            . "- 'І ще покажіть [тип] [конкретний колір] на [розмір]' -> action=send_product_photo для уточненої моделі; не додавай попередній товар до замовлення автоматично.\n"
    ...
    private function buildSafeReply(string $reply, string $stage, array $slotPatch): string
    {
        ...
        $cleanReply = $this->normalizeOrderWording($cleanReply);
    ...
    private function normalizeOrderWording(string $reply): string
    {
        $normalized = $reply;

        $replacements = [
            '/Додати в кошик\?/u' => 'Бажаєте замовити?',
            '/додати в кошик\?/ui' => 'Бажаєте замовити?',
            '/Добавить в корзину\?/u' => 'Бажаєте замовити?',
            '/добавить в корзину\?/ui' => 'Бажаєте замовити?',
            '/Додала в кошик/u' => 'Додала до замовлення',
            '/додала в кошик/ui' => 'додала до замовлення',
            '/Додав у кошик/u' => 'Додав до замовлення',
            '/додав у кошик/ui' => 'додав до замовлення',
            '/Додав в кошик/u' => 'Додав до замовлення',
            '/додав в кошик/ui' => 'додав до замовлення',
            '/Додаю в кошик/u' => 'Додаю до замовлення',
            '/додаю в кошик/ui' => 'додаю до замовлення',
            '/Додаємо в кошик/u' => 'Додаємо до замовлення',
            '/додаємо в кошик/ui' => 'додаємо до замовлення',
            '/Додавайте в кошик/u' => 'Додавайте до замовлення',
            '/додавайте в кошик/ui' => 'додавайте до замовлення',
            '/Додати в кошик/u' => 'додати до замовлення',
            '/додати в кошик/ui' => 'додати до замовлення',
            '/Добавить в корзину/u' => 'додати до замовлення',
            '/добавить в корзину/ui' => 'додати до замовлення',
            '/У кошик/u' => 'До замовлення',
            '/у кошик/ui' => 'до замовлення',
            '/В кошик/u' => 'До замовлення',
            '/в кошик/ui' => 'до замовлення',
        ];
