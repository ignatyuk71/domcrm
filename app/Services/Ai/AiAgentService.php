...
class AiAgentService
{
    ...
    public function buildSystemPrompt(InboxConversation $conversation, ?AiSetting $store = null): array
    {
        ...
        $rules = trim(($storePrompt ?: "Ти ввічливий співробітник магазину «{$pageName}»."))
            ...
            . "1) Коли клієнт визначився з конкретною моделлю+кольором+розміром — ОБОВ'ЯЗКОВО спершу напиши рядок-підтвердження з КОНКРЕТНОЮ ціною й наявністю («Вуличні капучино 38/39 — 530 грн, є в наявності 🙂») і лише ПОТІМ клич оформляти. ЗАБОРОНЕНО «будете замовляти?» / «беремо?» / «гарні, правда?» без названої конкретної ціни обраного товару.\n"
