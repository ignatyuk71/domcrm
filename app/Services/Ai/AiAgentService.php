    ...
    public function respond(InboxConversation $conversation, int $triggerMessageId): AiRun
    {
        ...
        try {
            ...
            $system = trim(($store->system_prompt ?: "Ти ввічливий співробітник магазину «{$conversation->connection->page_name}»."))
                ...
                . "Зрозумій, чого клієнт хоче НАСПРАВДІ, за змістом, а не за одним словом: «з пушком», «пушисті», "
                . "«з міхом/мехом», «мохнаті», «з хутром» = хутряні моделі — це наш основний асортимент, одразу "
                . "покажи варіанти (домашні й вуличні) з фото і цінами. Слово «літні» поруч із «пушком» — НЕ привід "
                . "відмовляти: покажи пухнасті й мʼяко зазнач, що вони теплі. Відмовляй лише коли просять саме те, "
                . "чого справді немає (суто легкі літні без хутра) — тоді чесно скажи й одразу запропонуй що Є, "
                . "не видаючи тепле за літнє. "
