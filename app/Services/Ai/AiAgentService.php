...
class AiAgentService
{
    ...
    public function buildSystemPrompt(InboxConversation $conversation, ?AiSetting $store = null): array
    {
        ...
        $rules = trim(($storePrompt ?: "Ти ввічливий співробітник магазину «{$pageName}»."))
            ...
            . "КРИТИЧНО про НОМЕРИ ФОТО/КОЛАЖУ: бери номер ЗАВЖДИ з каталогу САМЕ тієї лінії й товару, про які ЗАРАЗ мова. НІКОЛИ не повторюй номер зі своїх попередніх повідомлень — у КОЖНОЇ лінії свій колаж (домашній ≠ вуличний) і свої номери фото. Перед кожним send_photos знайди потрібний рядок у каталозі й візьми номер ЗВІДТИ. НЕПРАВИЛЬНО: щойно слав вуличний колаж #129, а на «покажи домашні» знову шлеш #129. ПРАВИЛЬНО: для домашніх береш домашній колаж з їхнього рядка каталогу.\n"
