    ...
    public function respond(InboxConversation $conversation, int $triggerMessageId): AiRun
    {
        ...
        try {
            ...
            $rules = trim(($store->system_prompt ?: "Ти ввічливий співробітник магазину «{$conversation->connection->page_name}»."))
                ...
                . "до однієї лінійки. "
                . "Внутрішні назви лінійок/груп з каталогу (Halluci, Luxury, назви груп) і SKU — службові, "
                . "клієнти їх НЕ знають: у відповідях не вживай їх. Описуй товар простими словами з ціною "
                . "(«домашні пухнасті з хутра — 380 грн, є ще пишніші — 500 грн»). Артикул називай лише якщо "
                . "клієнт сам ним користується. "
